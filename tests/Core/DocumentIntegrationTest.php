...
class DocumentIntegrationTest extends AppTestCase
{
    public function testGetDocumentShouldReturn200()
    {
        ...
        $this->assertSame($kerosConfig["BACKEND_URL"] . DIRECTORY_SEPARATOR . $kerosConfig['STUDY_DOCUMENT_DIRECTORY'] . 'study_1/document_2/acompte.docx', $body->location);
    }
    ...
    public function testPostDocumentShouldReturn200()
    {
        ...
        $kerosConfig = ConfigLoader::getConfig();
        $this->assertSame($kerosConfig["BACKEND_URL"] . DIRECTORY_SEPARATOR . $kerosConfig['STUDY_DOCUMENT_DIRECTORY'] . 'study_1/document_2', pathinfo($body->location, PATHINFO_DIRNAME));

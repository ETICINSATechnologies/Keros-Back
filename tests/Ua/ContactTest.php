...
class ContactTest extends TestCase
{
    public function testNewContactShouldBeInstanceOfContact()
    {
        $this->assertInstanceOf(Contact::class,
                                new Contact("Marah", "Tainturier", 1, 1, "marah.laurent@gmail.com",
                                            "0658984503", "0175389516", false));
    }

    public function testContactShouldCreateWithParams()
    {
        $Contact = new Contact("Marah", "Tainturier", 1, 1, "marah.laurent@gmail.com",
                               "0658984503", "0175389516", true);

...
INSERT INTO sg_member_inscription (id, firstName, lastName, genderId, birthday, departmentId, email, phoneNumber, outYear, nationalityId, wantedPoleId, addressId, hasPaid, droitImage, createdDate) VALUES
    ...
    (3, 'member inscription 3', 'member inscription 3 name', 3, STR_TO_DATE('1998/1/15', '%Y/%m/%d'), 9, 'memberInscription3@fake.com', '+33514785269', 2026, 115, 7, 56, true, false, STR_TO_DATE('2019/9/1', '%Y/%m/%d')),
    ...
    (6, 'member inscription 6', 'member inscription 6 name', 2, STR_TO_DATE('1998/1/15', '%Y/%m/%d'), 5, 'memberInscription6@fake.com', '+33514785269', 2023, 154, 2, 59, false, true, STR_TO_DATE('2019/9/1', '%Y/%m/%d')),
    ...
    (13, 'member inscription 13', 'member inscription 13 name', 2, STR_TO_DATE('1998/1/15', '%Y/%m/%d'), 8, 'memberInscription13@fake.com', '+33514785269', 2025, 22, 5, 66, true, true, STR_TO_DATE('2019/9/1', '%Y/%m/%d')),
    ...
    (16, 'member inscription 16', 'member inscription 16 name', 1, STR_TO_DATE('1998/1/15', '%Y/%m/%d'), 7, 'memberInscription16@fake.com', '+33514785269', 2024, 126, 3, 69, true, false, STR_TO_DATE('2019/9/1', '%Y/%m/%d')),
    (17, 'member inscription 17', 'member inscription 17 name', 3, STR_TO_DATE('1998/1/15', '%Y/%m/%d'), 9, 'memberInscription17@fake.com', '+33514785269', 2022, 183, 7, 70, false, true, STR_TO_DATE('2019/9/1', '%Y/%m/%d')),
    ...
    (20, 'member inscription 20', 'member inscription 20 name', 3, STR_TO_DATE('1998/1/15', '%Y/%m/%d'), 7, 'memberInscription20@fake.com', '+33514785269', 2024, 70, 3, 73, false, true, STR_TO_DATE('2019/9/1', '%Y/%m/%d')),
    ...
    (27, 'member inscription 27', 'member inscription 27 name', 4, STR_TO_DATE('1998/1/15', '%Y/%m/%d'), 1, 'memberInscription27@fake.com', '+33514785269', 2024, 2, 3, 80, false, false, STR_TO_DATE('2019/9/1', '%Y/%m/%d')),

...
INSERT INTO core_member (id, genderId, firstName, lastName, birthday, telephone, email, addressId, schoolYear, departmentId, company, profilePicture, droitImage, createdDate) VALUES
  ...
  (7, 3, 'Stéphane7', 'McMahon', STR_TO_DATE('1987-12-2', '%Y-%m-%d'), '+337425254', 'fake.maly7@fake.com', 10, 3, 4, NULL, NULL, true, STR_TO_DATE('2019/9/1', '%Y/%m/%d')),
...
INSERT INTO sg_member_inscription (id, firstName, lastName, genderId, birthday, departmentId, email, phoneNumber, outYear, nationalityId, wantedPoleId, addressId, hasPaid, droitImage, createdDate) VALUES
    (1, 'Bruce', 'Wayne', 1, STR_TO_DATE('2000/2/14', '%Y/%m/%d'), 3, 'bruce.wayne@batman.com', '0033123456789', 2021, 42, 8, 1, false, false, STR_TO_DATE('2019/9/1', '%Y/%m/%d')),
    (2, 'Clark', 'Kent', 1, STR_TO_DATE('1998/1/15', '%Y/%m/%d'), 2, 'clark.kent@dailyplanete.com', '0033123456789', 2023, 69, 4, 1, true, true, STR_TO_DATE('2019/9/1', '%Y/%m/%d')),
    (3, 'member inscription 3', 'member inscription 3 name', 3, STR_TO_DATE('1998/1/15', '%Y/%m/%d'), 9, 'memberInscription3@fake.com', '+33514785269', 2025, 115, 7, 56, true, false, STR_TO_DATE('2019/9/1', '%Y/%m/%d')),
    (4, 'member inscription 4', 'member inscription 4 name', 4, STR_TO_DATE('1998/1/15', '%Y/%m/%d'), 13, 'memberInscription4@fake.com', '+33514785269', 2020, 1, 4, 57, false, false, STR_TO_DATE('2019/9/1', '%Y/%m/%d')),
    (5, 'member inscription 5', 'member inscription 5 name', 1, STR_TO_DATE('1998/1/15', '%Y/%m/%d'), 2, 'memberInscription5@fake.com', '+33514785269', 2024, 60, 6, 58, false, true, STR_TO_DATE('2019/9/1', '%Y/%m/%d')),
    (6, 'member inscription 6', 'member inscription 6 name', 2, STR_TO_DATE('1998/1/15', '%Y/%m/%d'), 5, 'memberInscription6@fake.com', '+33514785269', 2022, 154, 2, 59, false, true, STR_TO_DATE('2019/9/1', '%Y/%m/%d')),
    (7, 'member inscription 7', 'member inscription 7 name', 4, STR_TO_DATE('1998/1/15', '%Y/%m/%d'), 2, 'memberInscription7@fake.com', '+33514785269', 2020, 182, 8, 60, false, false, STR_TO_DATE('2019/9/1', '%Y/%m/%d')),
    (8, 'member inscription 8', 'member inscription 8 name', 1, STR_TO_DATE('1998/1/15', '%Y/%m/%d'), 1, 'memberInscription8@fake.com', '+33514785269', 2021, 84, 6, 61, true, false, STR_TO_DATE('2019/9/1', '%Y/%m/%d')),
    (9, 'member inscription 9', 'member inscription 9 name', 1, STR_TO_DATE('1998/1/15', '%Y/%m/%d'), 1, 'memberInscription9@fake.com', '+33514785269', 2025, 87, 4, 62, true, true, STR_TO_DATE('2019/9/1', '%Y/%m/%d')),
    (10, 'member inscription 10', 'member inscription 10 name', 1, STR_TO_DATE('1998/1/15', '%Y/%m/%d'), 1, 'memberInscription10@fake.com', '+33514785269', 2025, 93, 4, 63, true, false, STR_TO_DATE('2019/9/1', '%Y/%m/%d')),
    (11, 'member inscription 11', 'member inscription 11 name', 1, STR_TO_DATE('1998/1/15', '%Y/%m/%d'), 7, 'memberInscription11@fake.com', '+33514785269', 2024, 131, 6, 64, false, true, STR_TO_DATE('2019/9/1', '%Y/%m/%d')),
    (12, 'member inscription 12', 'member inscription 12 name', 3, STR_TO_DATE('1998/1/15', '%Y/%m/%d'), 12, 'memberInscription12@fake.com', '+33514785269', 2025, 88, 8, 65, true, true, STR_TO_DATE('2019/9/1', '%Y/%m/%d')),
    (13, 'member inscription 13', 'member inscription 13 name', 2, STR_TO_DATE('1998/1/15', '%Y/%m/%d'), 8, 'memberInscription13@fake.com', '+33514785269', 2024, 22, 5, 66, true, true, STR_TO_DATE('2019/9/1', '%Y/%m/%d')),
    (14, 'member inscription 14', 'member inscription 14 name', 1, STR_TO_DATE('1998/1/15', '%Y/%m/%d'), 1, 'memberInscription14@fake.com', '+33514785269', 2023, 12, 6, 67, true, true, STR_TO_DATE('2019/9/1', '%Y/%m/%d')),
    (15, 'member inscription 15', 'member inscription 15 name', 3, STR_TO_DATE('1998/1/15', '%Y/%m/%d'), 12, 'memberInscription15@fake.com', '+33514785269', 2023, 76, 4, 68, false, false, STR_TO_DATE('2019/9/1', '%Y/%m/%d')),
    (16, 'member inscription 16', 'member inscription 16 name', 1, STR_TO_DATE('1998/1/15', '%Y/%m/%d'), 7, 'memberInscription16@fake.com', '+33514785269', 2023, 126, 3, 69, true, false, STR_TO_DATE('2019/9/1', '%Y/%m/%d')),
    (17, 'member inscription 17', 'member inscription 17 name', 3, STR_TO_DATE('1998/1/15', '%Y/%m/%d'), 9, 'memberInscription17@fake.com', '+33514785269', 2021, 183, 7, 70, false, true, STR_TO_DATE('2019/9/1', '%Y/%m/%d')),
    (18, 'member inscription 18', 'member inscription 18 name', 3, STR_TO_DATE('1998/1/15', '%Y/%m/%d'), 1, 'memberInscription18@fake.com', '+33514785269', 2022, 71, 5, 71, false, true, STR_TO_DATE('2019/9/1', '%Y/%m/%d')),
    (19, 'member inscription 19', 'member inscription 19 name', 1, STR_TO_DATE('1998/1/15', '%Y/%m/%d'), 6, 'memberInscription19@fake.com', '+33514785269', 2021, 70, 7, 72, true, false, STR_TO_DATE('2019/9/1', '%Y/%m/%d')),
    (20, 'member inscription 20', 'member inscription 20 name', 3, STR_TO_DATE('1998/1/15', '%Y/%m/%d'), 7, 'memberInscription20@fake.com', '+33514785269', 2023, 70, 3, 73, false, true, STR_TO_DATE('2019/9/1', '%Y/%m/%d')),
    (21, 'member inscription 21', 'member inscription 21 name', 4, STR_TO_DATE('1998/1/15', '%Y/%m/%d'), 6, 'memberInscription21@fake.com', '+33514785269', 2020, 195, 9, 74, false, true, STR_TO_DATE('2019/9/1', '%Y/%m/%d')),
    (22, 'member inscription 22', 'member inscription 22 name', 3, STR_TO_DATE('1998/1/15', '%Y/%m/%d'), 2, 'memberInscription22@fake.com', '+33514785269', 2020, 57, 6, 75, true, true, STR_TO_DATE('2019/9/1', '%Y/%m/%d')),
    (23, 'member inscription 23', 'member inscription 23 name', 2, STR_TO_DATE('1998/1/15', '%Y/%m/%d'), 4, 'memberInscription23@fake.com', '+33514785269', 2025, 14, 7, 76, true, false, STR_TO_DATE('2019/9/1', '%Y/%m/%d')),
    (24, 'member inscription 24', 'member inscription 24 name', 1, STR_TO_DATE('1998/1/15', '%Y/%m/%d'), 7, 'memberInscription24@fake.com', '+33514785269', 2021, 44, 4, 77, true, true, STR_TO_DATE('2019/9/1', '%Y/%m/%d')),
    (25, 'member inscription 25', 'member inscription 25 name', 1, STR_TO_DATE('1998/1/15', '%Y/%m/%d'), 3, 'memberInscription25@fake.com', '+33514785269', 2024, 131, 4, 78, true, false, STR_TO_DATE('2019/9/1', '%Y/%m/%d')),
    (26, 'member inscription 26', 'member inscription 26 name', 4, STR_TO_DATE('1998/1/15', '%Y/%m/%d'), 13, 'memberInscription26@fake.com', '+33514785269', 2023, 184, 4, 79, true, true, STR_TO_DATE('2019/9/1', '%Y/%m/%d')),
    (27, 'member inscription 27', 'member inscription 27 name', 4, STR_TO_DATE('1998/1/15', '%Y/%m/%d'), 1, 'memberInscription27@fake.com', '+33514785269', 2023, 2, 3, 80, false, false, STR_TO_DATE('2019/9/1', '%Y/%m/%d')),
    (28, 'member inscription 28', 'member inscription 28 name', 4, STR_TO_DATE('1998/1/15', '%Y/%m/%d'), 6, 'memberInscription28@fake.com', '+33514785269', 2021, 89, 6, 81, true, false, STR_TO_DATE('2019/9/1', '%Y/%m/%d')),
    (29, 'member inscription 29', 'member inscription 29 name', 4, STR_TO_DATE('1998/1/15', '%Y/%m/%d'), 3, 'memberInscription29@fake.com', '+33514785269', 2022, 141, 7, 82, true, true, STR_TO_DATE('2019/9/1', '%Y/%m/%d')),
    (30, 'member inscription 30', 'member inscription 30 name', 2, STR_TO_DATE('1998/1/15', '%Y/%m/%d'), 10, 'memberInscription30@fake.com', '+33514785269', 2025, 135, 4, 83, true, false, STR_TO_DATE('2019/9/1', '%Y/%m/%d'));

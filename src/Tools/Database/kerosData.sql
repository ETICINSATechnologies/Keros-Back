...
INSERT INTO core_member (id, genderId, firstName, lastName, birthday, telephone, email, addressId, schoolYear, departmentId, company, profilePicture, droitImage, createdDate, isAlumni, dateRepayment) VALUES
  ...
  (8, 3, 'Stéphane8', 'McMahon', STR_TO_DATE('1987-12-2', '%Y-%m-%d'), '+337425254', 'fake.maly8@fake.com', 11, 3, 4, NULL, NULL, true, STR_TO_DATE('2019/9/1', '%Y/%m/%d'), false, STR_TO_DATE('2019/9/1', '%Y/%m/%d')),
  (9, 3, 'Stéphane9', 'McMahon', STR_TO_DATE('1987-12-2', '%Y-%m-%d'), '+337425254', 'fake.maly9@fake.com', 12, 3, 4, NULL, NULL, true, STR_TO_DATE('2019/9/1', '%Y/%m/%d'), false, STR_TO_DATE('2019/9/1', '%Y/%m/%d')),
  (10, 3, 'Stéphane10', 'McMahon', STR_TO_DATE('1987-12-2', '%Y-%m-%d'), '+337425254', 'fake.maly10@fake.com', 13, 3, 4, NULL, NULL, true, STR_TO_DATE('2019/9/1', '%Y/%m/%d'), false, STR_TO_DATE('2019/9/1', '%Y/%m/%d')),
  (11, 3, 'Stéphane11', 'McMahon', STR_TO_DATE('1987-12-2', '%Y-%m-%d'), '+337425254', 'fake.maly11@fake.com', 14, 3, 4, NULL, NULL, true, STR_TO_DATE('2019/9/1', '%Y/%m/%d'), false, STR_TO_DATE('2019/9/1', '%Y/%m/%d')),
  (12, 3, 'Stéphane12', 'McMahon', STR_TO_DATE('1987-12-2', '%Y-%m-%d'), '+337425254', 'fake.maly12@fake.com', 15, 3, 4, NULL, NULL, true, STR_TO_DATE('2019/9/1', '%Y/%m/%d'), false, STR_TO_DATE('2019/9/1', '%Y/%m/%d')),
  (13, 3, 'Stéphane13', 'McMahon', STR_TO_DATE('1987-12-2', '%Y-%m-%d'), '+337425254', 'fake.maly13@fake.com', 16, 3, 4, NULL, NULL, true, STR_TO_DATE('2019/9/1', '%Y/%m/%d'), false, STR_TO_DATE('2019/9/1', '%Y/%m/%d')),
  (14, 3, 'Stéphane14', 'McMahon', STR_TO_DATE('1987-12-2', '%Y-%m-%d'), '+337425254', 'fake.maly14@fake.com', 17, 3, 4, NULL, NULL, true, STR_TO_DATE('2019/9/1', '%Y/%m/%d'), false, STR_TO_DATE('2019/9/1', '%Y/%m/%d')),
  (15, 3, 'Stéphane15', 'McMahon', STR_TO_DATE('1987-12-2', '%Y-%m-%d'), '+337425254', 'fake.maly15@fake.com', 18, 3, 4, NULL, NULL, true, STR_TO_DATE('2019/9/1', '%Y/%m/%d'), false, STR_TO_DATE('2019/9/1', '%Y/%m/%d')),
  (16, 3, 'Stéphane16', 'McMahon', STR_TO_DATE('1987-12-2', '%Y-%m-%d'), '+337425254', 'fake.maly16@fake.com', 19, 3, 4, NULL, NULL, true, STR_TO_DATE('2019/9/1', '%Y/%m/%d'), false, STR_TO_DATE('2019/9/1', '%Y/%m/%d')),
  (17, 3, 'Stéphane17', 'McMahon', STR_TO_DATE('1987-12-2', '%Y-%m-%d'), '+337425254', 'fake.maly17@fake.com', 20, 3, 4, NULL, NULL, true, STR_TO_DATE('2019/9/1', '%Y/%m/%d'), false, STR_TO_DATE('2019/9/1', '%Y/%m/%d')),
  (18, 3, 'Stéphane18', 'McMahon', STR_TO_DATE('1987-12-2', '%Y-%m-%d'), '+337425254', 'fake.maly18@fake.com', 21, 3, 4, NULL, NULL, true, STR_TO_DATE('2019/9/1', '%Y/%m/%d'), false, STR_TO_DATE('2019/9/1', '%Y/%m/%d')),
  (19, 3, 'Stéphane19', 'McMahon', STR_TO_DATE('1987-12-2', '%Y-%m-%d'), '+337425254', 'fake.maly19@fake.com', 22, 3, 4, NULL, NULL, true, STR_TO_DATE('2019/9/1', '%Y/%m/%d'), false, STR_TO_DATE('2019/9/1', '%Y/%m/%d')),
  (20, 3, 'Stéphane20', 'McMahon', STR_TO_DATE('1987-12-2', '%Y-%m-%d'), '+337425254', 'fake.maly20@fake.com', 23, 3, 4, NULL, NULL, true, STR_TO_DATE('2019/9/1', '%Y/%m/%d'), false, STR_TO_DATE('2019/9/1', '%Y/%m/%d')),
  (21, 3, 'Stéphane21', 'McMahon', STR_TO_DATE('1987-12-2', '%Y-%m-%d'), '+337425254', 'fake.maly21@fake.com', 24, 3, 4, NULL, NULL, true, STR_TO_DATE('2019/9/1', '%Y/%m/%d'), false, STR_TO_DATE('2019/9/1', '%Y/%m/%d')),
  (22, 3, 'Stéphane22', 'McMahon', STR_TO_DATE('1987-12-2', '%Y-%m-%d'), '+337425254', 'fake.maly22@fake.com', 25, 3, 4, NULL, NULL, true, STR_TO_DATE('2019/9/1', '%Y/%m/%d'), false, STR_TO_DATE('2019/9/1', '%Y/%m/%d')),
...
INSERT INTO core_consultant (id, genderId, firstName, lastName, birthday, telephone, nationalityId, email, addressId, socialSecurityNumber, schoolYear, departmentId, company, profilePicture, droitImage, isApprentice, createdDate, documentIdentity, documentScolaryCertificate, documentRIB, documentVitaleCard, documentResidencePermit, documentCVEC) VALUES
  (2, 1, 'Marah', 'Cool', STR_TO_DATE('1976-10-27', '%Y-%m-%d'), '+332541541', 42, 'fake.mail2@fake.com', 8, 123456789012345, 3, 1, 'Amazon', NULL, true, true, STR_TO_DATE('2019-09-01', '%Y-%m-%d'), 'test.pdf', 'test.pdf', 'test.pdf', 'test.pdf', 'test.pdf', 'test.pdf'),
  (5, 3, 'Louis', 'Ung', STR_TO_DATE('1987-11-2', '%Y-%m-%d'), '+337425254', 42, 'fake.mail3@fake.com', 7, 123456789012345, 3, 4, NULL, NULL, false, true, STR_TO_DATE('2019-09-01', '%Y-%m-%d'), NULL, NULL, NULL, NULL, NULL, NULL),
  (29, 1, 'Consultant 29', 'Consultant Name29', STR_TO_DATE('1987-11-2', '%Y-%m-%d'), '+337425254', 42, 'fake.consultant29@fake.com', 90, null, 1, 1, 'Fake Enterprise Consultant 29', NULL, true, true, STR_TO_DATE('2019-09-01', '%Y-%m-%d'), NULL, NULL, NULL, NULL, NULL, NULL),
  (30, 4, 'Consultant 30', 'Consultant Name30', STR_TO_DATE('1987-11-2', '%Y-%m-%d'), '+337425254', 42, 'fake.consultant30@fake.com', 91, null, 3, 11, 'Fake Enterprise Consultant 30', NULL, false, true, STR_TO_DATE('2019-09-01', '%Y-%m-%d'), NULL, NULL, NULL, NULL, NULL, NULL),
  (31, 4, 'Consultant 31', 'Consultant Name31', STR_TO_DATE('1987-11-2', '%Y-%m-%d'), '+337425254', 42, 'fake.consultant31@fake.com', 92, null, 5, 2, 'Fake Enterprise Consultant 31', NULL, true, true, STR_TO_DATE('2019-09-01', '%Y-%m-%d'), NULL, NULL, NULL, NULL, NULL, NULL),
  (32, 3, 'Consultant 32', 'Consultant Name32', STR_TO_DATE('1987-11-2', '%Y-%m-%d'), '+337425254', 42, 'fake.consultant32@fake.com', 93, null, 4, 7, 'Fake Enterprise Consultant 32', NULL, true, true, STR_TO_DATE('2019-09-01', '%Y-%m-%d'), NULL, NULL, NULL, NULL, NULL, NULL),
  (33, 4, 'Consultant 33', 'Consultant Name33', STR_TO_DATE('1987-11-2', '%Y-%m-%d'), '+337425254', 42, 'fake.consultant33@fake.com', 94, null, 8, 4, 'Fake Enterprise Consultant 33', NULL, false, true, STR_TO_DATE('2019-09-01', '%Y-%m-%d'), NULL, NULL, NULL, NULL, NULL, NULL),
  (34, 1, 'Consultant 34', 'Consultant Name34', STR_TO_DATE('1987-11-2', '%Y-%m-%d'), '+337425254', 42, 'fake.consultant34@fake.com', 95, null, 5, 7, 'Fake Enterprise Consultant 34', NULL, true, true, STR_TO_DATE('2019-09-01', '%Y-%m-%d'), NULL, NULL, NULL, NULL, NULL, NULL),
  (35, 1, 'Consultant 35', 'Consultant Name35', STR_TO_DATE('1987-11-2', '%Y-%m-%d'), '+337425254', 42, 'fake.consultant35@fake.com', 96, null, 5, 7, 'Fake Enterprise Consultant 35', NULL, true, true, STR_TO_DATE('2019-09-01', '%Y-%m-%d'), NULL, NULL, NULL, NULL, NULL, NULL),
  (36, 4, 'Consultant 36', 'Consultant Name36', STR_TO_DATE('1987-11-2', '%Y-%m-%d'), '+337425254', 42, 'fake.consultant36@fake.com', 97, null, 2, 12, 'Fake Enterprise Consultant 36', NULL, false, true, STR_TO_DATE('2019-09-01', '%Y-%m-%d'), NULL, NULL, NULL, NULL, NULL, NULL),
  (37, 1, 'Consultant 37', 'Consultant Name37', STR_TO_DATE('1987-11-2', '%Y-%m-%d'), '+337425254', 42, 'fake.consultant37@fake.com', 98, null, 7, 2, 'Fake Enterprise Consultant 37', NULL, false, true, STR_TO_DATE('2019-09-01', '%Y-%m-%d'), NULL, NULL, NULL, NULL, NULL, NULL),
  (38, 2, 'Consultant 38', 'Consultant Name38', STR_TO_DATE('1987-11-2', '%Y-%m-%d'), '+337425254', 42, 'fake.consultant38@fake.com', 99, null, 2, 7, 'Fake Enterprise Consultant 38', NULL, true, true, STR_TO_DATE('2019-09-01', '%Y-%m-%d'), NULL, NULL, NULL, NULL, NULL, NULL),
  (39, 3, 'Consultant 39', 'Consultant Name39', STR_TO_DATE('1987-11-2', '%Y-%m-%d'), '+337425254', 42, 'fake.consultant39@fake.com', 100, null, 2, 11, 'Fake Enterprise Consultant 39', NULL, false, true, STR_TO_DATE('2019-09-01', '%Y-%m-%d'), NULL, NULL, NULL, NULL, NULL, NULL),
  (40, 3, 'Consultant 40', 'Consultant Name40', STR_TO_DATE('1987-11-2', '%Y-%m-%d'), '+337425254', 42, 'fake.consultant40@fake.com', 101, null, 1, 11, 'Fake Enterprise Consultant 40', NULL, false, true, STR_TO_DATE('2019-09-01', '%Y-%m-%d'), NULL, NULL, NULL, NULL, NULL, NULL),
  (41, 2, 'Consultant 41', 'Consultant Name41', STR_TO_DATE('1987-11-2', '%Y-%m-%d'), '+337425254', 42, 'fake.consultant41@fake.com', 102, null, 1, 3, 'Fake Enterprise Consultant 41', NULL, false, true, STR_TO_DATE('2019-09-01', '%Y-%m-%d'), NULL, NULL, NULL, NULL, NULL, NULL),
  (42, 3, 'Consultant 42', 'Consultant Name42', STR_TO_DATE('1987-11-2', '%Y-%m-%d'), '+337425254', 42, 'fake.consultant42@fake.com', 103, null, 7, 6, 'Fake Enterprise Consultant 42', NULL, false, true, STR_TO_DATE('2019-09-01', '%Y-%m-%d'), NULL, NULL, NULL, NULL, NULL, NULL),
  (43, 3, 'Consultant 43', 'Consultant Name43', STR_TO_DATE('1987-11-2', '%Y-%m-%d'), '+337425254', 42, 'fake.consultant43@fake.com', 104, null, 6, 11, 'Fake Enterprise Consultant 43', NULL, true, true, STR_TO_DATE('2019-09-01', '%Y-%m-%d'), NULL, NULL, NULL, NULL, NULL, NULL),
  (44, 3, 'Consultant 44', 'Consultant Name44', STR_TO_DATE('1987-11-2', '%Y-%m-%d'), '+337425254', 42, 'fake.consultant44@fake.com', 105, null, 7, 2, 'Fake Enterprise Consultant 44', NULL, true, true, STR_TO_DATE('2019-09-01', '%Y-%m-%d'), NULL, NULL, NULL, NULL, NULL, NULL),
  (45, 1, 'Consultant 45', 'Consultant Name45', STR_TO_DATE('1987-11-2', '%Y-%m-%d'), '+337425254', 42, 'fake.consultant45@fake.com', 106, null, 7, 11, 'Fake Enterprise Consultant 45', NULL, true, true, STR_TO_DATE('2019-09-01', '%Y-%m-%d'), NULL, NULL, NULL, NULL, NULL, NULL),
  (46, 1, 'Consultant 46', 'Consultant Name46', STR_TO_DATE('1987-11-2', '%Y-%m-%d'), '+337425254', 42, 'fake.consultant46@fake.com', 107, null, 6, 5, 'Fake Enterprise Consultant 46', NULL, true, true, STR_TO_DATE('2019-09-01', '%Y-%m-%d'), NULL, NULL, NULL, NULL, NULL, NULL),
  (47, 2, 'Consultant 47', 'Consultant Name47', STR_TO_DATE('1987-11-2', '%Y-%m-%d'), '+337425254', 42,'fake.consultant47@fake.com', 108, null, 5, 4, 'Fake Enterprise Consultant 47', NULL, true, true, STR_TO_DATE('2019-09-01', '%Y-%m-%d'), NULL, NULL, NULL, NULL, NULL, NULL),
  (48, 1, 'Consultant 48', 'Consultant Name48', STR_TO_DATE('1987-11-2', '%Y-%m-%d'), '+337425254', 42, 'fake.consultant48@fake.com', 109, null, 2, 7, 'Fake Enterprise Consultant 48', NULL, true, true, STR_TO_DATE('2019-09-01', '%Y-%m-%d'), NULL, NULL, NULL, NULL, NULL, NULL),
  (49, 4, 'Consultant 49', 'Consultant Name49', STR_TO_DATE('1987-11-2', '%Y-%m-%d'), '+337425254', 42, 'fake.consultant49@fake.com', 110, null, 2, 7, 'Fake Enterprise Consultant 49', NULL, true, true, STR_TO_DATE('2019-09-01', '%Y-%m-%d'), NULL, NULL, NULL, NULL, NULL, NULL),
  (50, 1, 'Consultant 50', 'Consultant Name50', STR_TO_DATE('1987-11-2', '%Y-%m-%d'), '+337425254', 42, 'fake.consultant50@fake.com', 111, null, 7, 5, 'Fake Enterprise Consultant 50', NULL, true, true, STR_TO_DATE('2019-09-01', '%Y-%m-%d'), NULL, NULL, NULL, NULL, NULL, NULL),
  (51, 1, 'Consultant 51', 'Consultant Name51', STR_TO_DATE('1987-11-2', '%Y-%m-%d'), '+337425254', 42, 'fake.consultant51@fake.com', 112, null, 8, 10, 'Fake Enterprise Consultant 51', NULL, true, true, STR_TO_DATE('2019-09-01', '%Y-%m-%d'), NULL, NULL, NULL, NULL, NULL, NULL),
  (52, 3, 'Consultant 52', 'Consultant Name52', STR_TO_DATE('1987-11-2', '%Y-%m-%d'), '+337425254', 42, 'fake.consultant52@fake.com', 113, null, 5, 10, 'Fake Enterprise Consultant 52', NULL, false, true, STR_TO_DATE('2019-09-01', '%Y-%m-%d'), NULL, NULL, NULL, NULL, NULL, NULL),
  (53, 3, 'Consultant 53', 'Consultant Name53', STR_TO_DATE('1987-11-2', '%Y-%m-%d'), '+337425254', 42,'fake.consultant53@fake.com', 114, null, 3, 2, 'Fake Enterprise Consultant 53', NULL, false, true, STR_TO_DATE('2019-09-01', '%Y-%m-%d'), NULL, NULL, NULL, NULL, NULL, NULL),
  (54, 4, 'Consultant 54', 'Consultant Name54', STR_TO_DATE('1987-11-2', '%Y-%m-%d'), '+337425254', 42,'fake.consultant54@fake.com', 115, null, 4, 4, 'Fake Enterprise Consultant 54', NULL, true, true, STR_TO_DATE('2019-09-01', '%Y-%m-%d'), NULL, NULL, NULL, NULL, NULL, NULL),
  (55, 3, 'Consultant 55', 'Consultant Name55', STR_TO_DATE('1987-11-2', '%Y-%m-%d'), '+337425254', 42,'fake.consultant55@fake.com', 116, null, 7, 3, 'Fake Enterprise Consultant 55', NULL, false, true, STR_TO_DATE('2019-09-01', '%Y-%m-%d'), NULL, NULL, NULL, NULL, NULL, NULL);
...
INSERT INTO sg_member_inscription (id, firstName, lastName, genderId, birthday, departmentId, email, phoneNumber, outYear, nationalityId, wantedPoleId, addressId, hasPaid, droitImage, createdDate, dateRepayment) VALUES
    (1, 'Bruce', 'Wayne', 1, STR_TO_DATE('2000/2/14', '%Y/%m/%d'), 3, 'bruce.wayne@batman.com', '0033123456789', 2022, 42, 8, 1, false, false, STR_TO_DATE('2019/9/1', '%Y/%m/%d'), STR_TO_DATE('2019/9/1', '%Y/%m/%d')),
    (2, 'Clark', 'Kent', 1, STR_TO_DATE('1998/1/15', '%Y/%m/%d'), 2, 'clark.kent@dailyplanete.com', '0033123456789', 2024, 69, 4, 1, true, true, STR_TO_DATE('2019/9/1', '%Y/%m/%d'), STR_TO_DATE('2019/9/1', '%Y/%m/%d')),
    (3, 'member ìnscription 3', 'member inscription 3 name', 3, STR_TO_DATE('1998/1/15', '%Y/%m/%d'), 7, 'memberInscription3@fake.com', '+33514785269', 2026, 115, 7, 56, true, false, STR_TO_DATE('2019/9/1', '%Y/%m/%d'), STR_TO_DATE('2019/9/1', '%Y/%m/%d')),
    (4, 'member inscription 4', 'member inscription 4 name', 4, STR_TO_DATE('1998/1/15', '%Y/%m/%d'), 13, 'memberInscription4@fake.com', '+33514785269', 2021, 1, 4, 57, false, false, STR_TO_DATE('2019/9/1', '%Y/%m/%d'), STR_TO_DATE('2019/9/1', '%Y/%m/%d')),
    (5, 'member inscription 5', 'member inscription 5 name', 1, STR_TO_DATE('1998/1/15', '%Y/%m/%d'), 2, 'memberInscription5@fake.com', '+33514785269', 2025, 60, 6, 58, false, true, STR_TO_DATE('2019/9/1', '%Y/%m/%d'), STR_TO_DATE('2019/9/1', '%Y/%m/%d')),
    (6, 'member inscription 6', 'member inscription 6 name', 2, STR_TO_DATE('1998/1/15', '%Y/%m/%d'), 5, 'memberInscription6@fake.com', '+33514785269', 2023, 154, 4, 59, false, true, STR_TO_DATE('2019/9/1', '%Y/%m/%d'), STR_TO_DATE('2019/9/1', '%Y/%m/%d')),
    (7, 'member inscription 7', 'member inscription 7 name', 4, STR_TO_DATE('1998/1/15', '%Y/%m/%d'), 2, 'memberInscription7@fake.com', '+33514785269', 2021, 182, 8, 60, false, false, STR_TO_DATE('2019/9/1', '%Y/%m/%d'), STR_TO_DATE('2019/9/1', '%Y/%m/%d')),
    (8, 'member inscription 8', 'member inscription 8 name', 1, STR_TO_DATE('1998/1/15', '%Y/%m/%d'), 1, 'memberInscription8@fake.com', '+33514785269', 2022, 84, 6, 61, true, false, STR_TO_DATE('2019/9/1', '%Y/%m/%d'), STR_TO_DATE('2019/9/1', '%Y/%m/%d')),
    (9, 'member inscription 9', 'member inscription 9 name', 1, STR_TO_DATE('1998/1/15', '%Y/%m/%d'), 1, 'memberInscription9@fake.com', '+33514785269', 2026, 87, 4, 62, true, true, STR_TO_DATE('2019/9/1', '%Y/%m/%d'), STR_TO_DATE('2019/9/1', '%Y/%m/%d')),
    (10, 'member inscription 10', 'member inscription 10 name', 1, STR_TO_DATE('1998/1/15', '%Y/%m/%d'), 1, 'memberInscription10@fake.com', '+33514785269', 2026, 93, 4, 63, true, false, STR_TO_DATE('2019/9/1', '%Y/%m/%d'), STR_TO_DATE('2019/9/1', '%Y/%m/%d')),
    (11, 'member inscription 11', 'member inscription 11 name', 1, STR_TO_DATE('1998/1/15', '%Y/%m/%d'), 7, 'memberInscription11@fake.com', '+33514785269', 2025, 131, 6, 64, false, true, STR_TO_DATE('2019/9/1', '%Y/%m/%d'), STR_TO_DATE('2019/9/1', '%Y/%m/%d')),
    (12, 'member inscription 12', 'member inscription 12 name', 3, STR_TO_DATE('1998/1/15', '%Y/%m/%d'), 12, 'memberInscription12@fake.com', '+33514785269', 2026, 88, 8, 65, true, true, STR_TO_DATE('2019/9/1', '%Y/%m/%d'), STR_TO_DATE('2019/9/1', '%Y/%m/%d')),
    (13, 'member inscription 13', 'member inscription 13 name', 2, STR_TO_DATE('1998/1/15', '%Y/%m/%d'), 7, 'memberInscription13@fake.com', '+33514785269', 2025, 22, 5, 66, true, true, STR_TO_DATE('2019/9/1', '%Y/%m/%d'), STR_TO_DATE('2019/9/1', '%Y/%m/%d')),
    (14, 'member inscription 14', 'member inscription 14 name', 1, STR_TO_DATE('1998/1/15', '%Y/%m/%d'), 1, 'memberInscription14@fake.com', '+33514785269', 2024, 12, 6, 67, true, true, STR_TO_DATE('2019/9/1', '%Y/%m/%d'), STR_TO_DATE('2019/9/1', '%Y/%m/%d')),
    (15, 'member inscription 15', 'member inscription 15 name', 3, STR_TO_DATE('1998/1/15', '%Y/%m/%d'), 12, 'memberInscription15@fake.com', '+33514785269', 2024, 76, 4, 68, false, false, STR_TO_DATE('2019/9/1', '%Y/%m/%d'), STR_TO_DATE('2019/9/1', '%Y/%m/%d')),
    (16, 'member inscription 16', 'member inscription 16 name', 1, STR_TO_DATE('1998/1/15', '%Y/%m/%d'), 7, 'memberInscription16@fake.com', '+33514785269', 2024, 126, 9, 69, true, false, STR_TO_DATE('2019/9/1', '%Y/%m/%d'), STR_TO_DATE('2019/9/1', '%Y/%m/%d')),
    (17, 'member inscription 17', 'member inscription 17 name', 3, STR_TO_DATE('1998/1/15', '%Y/%m/%d'), 7, 'memberInscription17@fake.com', '+33514785269', 2022, 183, 7, 70, false, true, STR_TO_DATE('2019/9/1', '%Y/%m/%d'), STR_TO_DATE('2019/9/1', '%Y/%m/%d')),
    (18, 'member inscription 18', 'member inscription 18 name', 3, STR_TO_DATE('1998/1/15', '%Y/%m/%d'), 1, 'memberInscription18@fake.com', '+33514785269', 2023, 71, 5, 71, false, true, STR_TO_DATE('2019/9/1', '%Y/%m/%d'), STR_TO_DATE('2019/9/1', '%Y/%m/%d')),
    (19, 'member inscription 19', 'member inscription 19 name', 1, STR_TO_DATE('1998/1/15', '%Y/%m/%d'), 6, 'memberInscription19@fake.com', '+33514785269', 2022, 70, 7, 72, true, false, STR_TO_DATE('2019/9/1', '%Y/%m/%d'), STR_TO_DATE('2019/9/1', '%Y/%m/%d')),
    (20, 'member inscription 20', 'member inscription 20 name', 3, STR_TO_DATE('1998/1/15', '%Y/%m/%d'), 7, 'memberInscription20@fake.com', '+33514785269', 2024, 70, 9, 73, false, true, STR_TO_DATE('2019/9/1', '%Y/%m/%d'), STR_TO_DATE('2019/9/1', '%Y/%m/%d')),
    (21, 'member inscription 21', 'member inscription 21 name', 4, STR_TO_DATE('1998/1/15', '%Y/%m/%d'), 6, 'memberInscription21@fake.com', '+33514785269', 2021, 195, 9, 74, false, true, STR_TO_DATE('2019/9/1', '%Y/%m/%d'), STR_TO_DATE('2019/9/1', '%Y/%m/%d')),
    (22, 'member inscription 22', 'member inscription 22 name', 3, STR_TO_DATE('1998/1/15', '%Y/%m/%d'), 2, 'memberInscription22@fake.com', '+33514785269', 2021, 57, 6, 75, true, true, STR_TO_DATE('2019/9/1', '%Y/%m/%d'), STR_TO_DATE('2019/9/1', '%Y/%m/%d')),
    (23, 'member inscription 23', 'member inscription 23 name', 2, STR_TO_DATE('1998/1/15', '%Y/%m/%d'), 4, 'memberInscription23@fake.com', '+33514785269', 2026, 14, 7, 76, true, false, STR_TO_DATE('2019/9/1', '%Y/%m/%d'), STR_TO_DATE('2019/9/1', '%Y/%m/%d')),
    (24, 'member inscription 24', 'member inscription 24 name', 1, STR_TO_DATE('1998/1/15', '%Y/%m/%d'), 7, 'memberInscription24@fake.com', '+33514785269', 2022, 44, 4, 77, true, true, STR_TO_DATE('2019/9/1', '%Y/%m/%d'), STR_TO_DATE('2019/9/1', '%Y/%m/%d')),
    (25, 'member inscription 25', 'member inscription 25 name', 1, STR_TO_DATE('1998/1/15', '%Y/%m/%d'), 3, 'memberInscription25@fake.com', '+33514785269', 2025, 131, 4, 78, true, false, STR_TO_DATE('2019/9/1', '%Y/%m/%d'), STR_TO_DATE('2019/9/1', '%Y/%m/%d')),
    (26, 'member inscription 26', 'member inscription 26 name', 4, STR_TO_DATE('1998/1/15', '%Y/%m/%d'), 13, 'memberInscription26@fake.com', '+33514785269', 2024, 184, 4, 79, true, true, STR_TO_DATE('2019/9/1', '%Y/%m/%d'), STR_TO_DATE('2019/9/1', '%Y/%m/%d')),
    (27, 'member inscription 27', 'member inscription 27 name', 4, STR_TO_DATE('1998/1/15', '%Y/%m/%d'), 1, 'memberInscription27@fake.com', '+33514785269', 2024, 2, 9, 80, false, false, STR_TO_DATE('2019/9/1', '%Y/%m/%d'), STR_TO_DATE('2019/9/1', '%Y/%m/%d')),
    (28, 'member inscription 28', 'member inscription 28 name', 4, STR_TO_DATE('1998/1/15', '%Y/%m/%d'), 6, 'memberInscription28@fake.com', '+33514785269', 2022, 89, 6, 81, true, false, STR_TO_DATE('2019/9/1', '%Y/%m/%d'), STR_TO_DATE('2019/9/1', '%Y/%m/%d')),
    (29, 'member inscription 29', 'member inscription 29 name', 4, STR_TO_DATE('1998/1/15', '%Y/%m/%d'), 3, 'memberInscription29@fake.com', '+33514785269', 2023, 141, 7, 82, true, true, STR_TO_DATE('2019/9/1', '%Y/%m/%d'), STR_TO_DATE('2019/9/1', '%Y/%m/%d')),
    (30, 'member inscription 30', 'member inscription 30 name', 2, STR_TO_DATE('1998/1/15', '%Y/%m/%d'), 10, 'memberInscription30@fake.com', '+33514785269', 2026, 135, 4, 83, true, false, STR_TO_DATE('2019/9/1', '%Y/%m/%d'), STR_TO_DATE('2019/9/1', '%Y/%m/%d'));
